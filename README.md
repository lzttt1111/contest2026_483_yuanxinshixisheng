...
2026-09-20 皮肤算法补充：V2十二项/四光源、水光三项云服务、PC目标检测与拍照源码见 [皮肤算法提交说明](contest_submission/skin-algorithms.md)，包含视觉Skill和 lzttt1111 的真实AI日志。最新修复已禁用固定样例分数回退并补齐正面采集槽位，剩余评分参考和实拍边界见说明。
