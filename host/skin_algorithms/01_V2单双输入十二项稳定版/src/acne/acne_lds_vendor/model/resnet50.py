...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, num_acne_cls=4):
        ...
        # Production inference immediately loads a complete Acne-LDS
        # checkpoint.  Avoid an unnecessary ImageNet network download here;
        # the checkpoint below is the sole source of inference weights.
