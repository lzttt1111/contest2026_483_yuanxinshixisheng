...
class SurfaceGlossAnalyzer:
    ...
    def process_preprocess_result(
        ...
        if enabled():
            save(os.path.dirname(paths["overlay"]), "surface_gloss",
                 {"valid": result.gloss_analysis_mask, "landmarks": preprocess_result.landmarks,
                  "instances": result.gloss_mask, "high": result.high_gloss_mask,
                  "score": result.gloss_intensity_map},
