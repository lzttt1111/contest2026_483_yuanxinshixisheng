...
INCREMENTAL_OVERALL_METRICS = frozenset({"total_wrinkle_length_px", "p50_segment_length_px_proxy", "p90_segment_length_px_proxy", "mean_visible_width_px_proxy", "p90_visual_contrast_proxy", "wrinkle_continuity"})
